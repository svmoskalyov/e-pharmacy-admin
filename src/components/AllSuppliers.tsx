...
function AllSuppliers({ suppliers }: AllSuppliersProps) {
  ...
  const [supplierItem, setSupplierItem] = useState<Supplier>()
  ...
  return (
    <>
      ...
      <Popup open={openPopup} onClose={handleModal} title={'Edit supplier'}>
        <SupplierForm suppItem={supplierItem} onClose={handleModal} />
      </Popup>
    </>
  )
}
